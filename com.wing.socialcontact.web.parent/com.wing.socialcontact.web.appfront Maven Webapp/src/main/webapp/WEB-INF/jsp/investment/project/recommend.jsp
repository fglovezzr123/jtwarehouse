...
<form id="dataForm">
    <div class="wrapper">
         ...
         <div class="info-forms">
              ...
              <input type="text" placeholder="必填项" name="comName" id="comName" maxlength="50"
              	onkeyup="textCheck(this)" />
         </div>
         <div class="info-forms" style="border:none">
              <div class="info-forms-name">注册资本</div>
              <input type="number" placeholder="注册资本在0.01-9999.99之间" name="registeredCapital" id="registeredCapital"
              		 onkeyup="num(this)" onblur="value=(value==0?'':value)" maxlength="6"
              		onafterpaste="return false" onpaste="return false"/> 万
         </div>
         ...
         <div class="info-forms">
             ...
             <input type="text" placeholder="请输入项目描述" name="prjDesc" id="prjDesc" maxlength="50" onkeyup="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" onpaste="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" oncontextmenu="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" />
         </div>
         <div class="projectDpict">
              <div>项目介绍</div>
             <textarea placeholder="请输入项目介绍" name="prjProfile" id="prjProfile" maxlength="200" onkeyup="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" onpaste="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" oncontextmenu="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" ></textarea>
             <br class="clear"/>
         </div>
