...
public class StringUtil {
	...
	public static String filterJson(String s) {
		...
		return s.replaceAll("\b", "\\\\b").replaceAll("\t", "\\\\t")
				.replaceAll("\n", "\\\\n").replaceAll("\f", "\\\\f")
...
//		System.out.println(StringUtil.length("leng7leng7leng7leng7leng7leng7leng7leng7多个手机号之间用，隔11111"));
	...
	public static boolean isNumeric(String pageNum) {
		try {
	...
	/**
	 * objectList 转换MapList
	 * @param list
	 * @return
	 * @throws Exception
	 */
	public static List<Map> objectListToMapList(List list)throws Exception{
		if(list == null){
			return null;
		}
	 ...
	 * @throws Exception
	 */
	public static String createStringNo(){
	 ...
	 * @return
	 */
	public static String fixed(Double d){
