...
<html lang="en">
        ...
        <div class="wrapper">
             <div class="right-signal">
                  ...
                  <div class="name-head1">
                       	<span id="sp">3秒后进入我报名的活动列表 </span>
                  </div></br>
             <div class="active_A name-btn" onclick="jumpurl('${path}/wx/netWork/netWork.do');">返回人脉圈</div></br>
             <div class="active_A name-btn" onclick="jumpurl('${path}/m/my/myfootPrint_activity.do');">查看我的活动</div>
         </div>
    </body>
    <script type="text/javascript">
		    ...
		    function go(){  
		    	x--;  
		        if(x>0){  
		        	document.getElementById("sp").innerHTML=x+"秒后进入我报名的活动列表 ";  //每次设置的x的值都不一样了。  
		        }else{  
