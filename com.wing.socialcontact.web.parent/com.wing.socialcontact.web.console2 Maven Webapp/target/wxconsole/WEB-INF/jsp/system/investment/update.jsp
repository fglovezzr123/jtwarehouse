...
<div style="width: 800px;margin: 0 auto;" >
	<form  action="investment/update.do"  method="post" id="investment_form" afterCallback="saveCallback" enctype="multipart/form-data" >
		  ...
		  <table class="table table-nobordered " style="margin-top: 25px;">
			  ...
			  <tr>
			  	<th>业务简介</th>
			  	<td><textarea  id="content1" name="introduce" rows="3" cols="">${dto.introduce }</textarea></td>
			  </tr>
			  <tr>
			  	<th>产品特色</th>
			  	<td><textarea  id="content2" name="feature"  rows="3" cols="">${dto.feature }</textarea></td>
			  </tr>
			  <tr>
				 <th></th>
				 <td>
		 ...
		 <input type="hidden" name="classId" value="${dto.classId }"/>
...
$(document.body).ready(function(){
	...
	$("#${dto.classId}").attr("selected","selected");
})
