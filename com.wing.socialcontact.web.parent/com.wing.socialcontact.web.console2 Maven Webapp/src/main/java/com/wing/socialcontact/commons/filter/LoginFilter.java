 ...
 * @Package com.wing.socialcontact.commons.filter
 * @date 2016-6-4 上午10:29:57
 * @Copyright: 2016 
 */
package com.wing.socialcontact.commons.filter;
...
public class LoginFilter implements Filter{
	...
	public void doFilter(ServletRequest arg0, ServletResponse arg1,FilterChain chain) throws IOException, ServletException {
		...
		try {
			IpInfo ipInfo=IpUtil.getIpInfo(IpUtil.getIpAddr(request));
			ServletUtil.setIpInfo(ipInfo);
		} catch (Exception e) {
		}
