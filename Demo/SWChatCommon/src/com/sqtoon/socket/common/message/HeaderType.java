...
public class HeaderType
{
	...
	public static final byte PushToken = (byte) 0x10;
	public static final byte Key = (byte) 0x12;
	public static final byte Status = (byte) 0x13;
	public static final byte DeviceToken = (byte) 0x14;
	...
	public static final byte Fpid = (byte) 0xF9;
	public static final byte Tpid = (byte) 0xFA;
	...
	static
	{
		try
		{
			Class<?> headertype = Class.forName(HeaderType.class.getCanonicalName());
	...
	/**
	 * Obtain the specified type string expression
	 * 
	 * @param type
	 * @return Header type in string format
	 */
