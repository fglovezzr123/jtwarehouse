				...
				zdy_ajax({
					...
					success: function(data,res){
						...
						$.each(data,function(index){
							 ...
							 var str = '<div nickName="'+data[index].group_name+'" class="myTalk active_A ccc" creator="'+data[index].creator+'" qno="'+data[index].tid+'" qid="'+data[index].group_id+'"><div class="myTalk-l"><span class="iconsssss"><img src="'+headpath+'" /></span><span>'+data[index].group_name+'</span></div><span class="time"></span></div>' 
						...
						$('.myTalk').on('click',function(){
							...
							sessionStorage.setItem('groupNo163',qno);
