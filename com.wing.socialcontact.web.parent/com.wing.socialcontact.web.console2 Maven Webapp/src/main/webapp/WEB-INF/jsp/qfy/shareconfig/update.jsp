...
--%>
	...
	<form  action="qfy/shareconfig/update.do"  id="quickDetailBanner_form"   method="post"   onsubmit="return validateSubmitForm(this)">
			  ...
			  <tr>
				 ...
				 <td>
					<div  style="margin-top: 10px;margin-bottom: 10px;">
						  ...
						  <button type="button" class="btn btn-primary"  style="display:none;"  onclick="save()">保存</button>&nbsp;&nbsp;&nbsp;&nbsp;
					</div>
				 </td>
			  </tr>
