			   ...
			   if(res.code == 0){
					...
					$.each(res.dataobj, function(i, n){
						...
						if(honor_flag=="honor_001"){
							tjIdImg = '<div style="flex: 1; margin-left: .1rem;margin-top:-0.3rem;"><img src="${path}/resource/img/icons/tjjr.png"  class="tj" /></div>'
						}else if(honor_flag=="honor_002"){
							tjIdImg = '<div style="flex: 1; margin-left: .1rem;margin-top:-0.3rem;"><img src="${path}/resource/img/icons/tjyq.png"  class="tj" /></div>'
						}else if(honor_flag=="honor_003"){
							tjIdImg = '<div style="flex: 1; margin-left: .1rem;margin-top:-0.3rem;"><img src="${path}/resource/img/icons/tjhb.png"  class="tj" /></div>'
						}else if(honor_flag=="honor_004"){
							tjIdImg = '<div style="flex: 1; margin-left: .1rem;margin-top:-0.3rem;"><img src="${path}/resource/img/icons/tjfws.png"  class="tj" /></div>'
						}
						...
						'<div class="person"><span class="p-name" style="display:flex">'+n.nickname+'</span><span class="company">'+n.comName+'</span>'+
						'</div>'+tjIdImg+'</div><div class="j-tit" onclick="openurl(\'${path}/m/topic/detailPage.do?id='+n.id+'\')">'+n.topicDesc+'</div><div class="t-info">'+
