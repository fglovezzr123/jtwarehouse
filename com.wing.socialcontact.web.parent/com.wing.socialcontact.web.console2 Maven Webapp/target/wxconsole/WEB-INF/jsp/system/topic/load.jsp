...
<script type="text/javascript">	
				...
				columns : [ [
						...
						},
						{
							...
							formatter: function(rowIndex, rowData){
								...
								"<a href = 'javaScript:void(0)' onclick = showviewck('"+rowData.id+"')>查看</a>";
							}
						}
	...
	function showviewck(fid){
		MUI.openDialog('查看详情','topic/view.do?id='+fid+'&rel=<%=request.getParameter("rel")%>','<%=request.getParameter("rel")%>_show',{width:650,height:450});
	}
