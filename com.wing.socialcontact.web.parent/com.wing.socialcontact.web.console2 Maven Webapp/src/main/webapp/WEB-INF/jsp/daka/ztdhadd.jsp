...
<table id="signup1_datagrid" toolbar="#signup_toolbar"></table>
...
function loadMain(){
	$("#signup1_datagrid").datagrid({
		url : "daka/ztdhquery.do?isztdh=0", 
		rownumbers: true,
		queryParams: { 
...
function serchData(){
	$("#signup1_datagrid").datagrid('reload',{
		nickname: $("#nickname_sub").val(),
		job: $("#job_sub").val(),
		industry: $("#industry_sub").val()
	});
...
function closeDakaaddpage(){
	$("#ztdhaddpage").dialog("destroy");
}

function sureDakaUser(){
	var rows = $("#signup1_datagrid").datagrid("getChecked");
