...
--%>
	...
	<form  action="userhonor/updateUser.do"  id="user_form"  method="post"   onsubmit="return validateSubmitForm(this)">
	 <input id="imgUrl" name="imgUrl" value="${wxUser.imgUrl}"  type="hidden" />
		<div class="divider"></div>
		  <table class="table table-nobordered " style="margin-top: 25px;">
		 
		 	  <tr>
			    	<th style="width: 120px">用戶图片：</th>
			    	<td >
			   ...
			   <tr>
				...
				<td>
					<input type="text" id="phone" name="mobile" class="easyui-numberbox"   value="${wxUser.mobile}" required="true"  data-options="validType:['mPhone']" />
				</td>
			  </tr>
			  <tr>
			    	<th style="width: 120px">认证姓名：</th>
			    	<td>
			     		<input type="text" name="nickName" class="easyui-validatebox" required="true"   value="${wxUser.nickName}"  data-options="validType:['length[1,20]']"   maxlength="30" />
			    	</td>
			  </tr>
			  <!-- <tr>
			    	<th style="width: 120px">认证名称：</th>
			    	<td>
			     		<input type="text" name="username" class="easyui-validatebox" required="true"  value="${wxUser.username}"  data-options="validType:['length[1,20]']"   maxlength="30" />
			    	</td>
			  </tr> -->
		 	  <tr>
			    	<th style="width: 120px">性别：</th>
			    	<td >
			    	<select  name="sex" id="sex"  sValue="${wxUser.sex }" >
			  ...
			  <tr>
			    	...
			    	<td>
			     		<input type="text" name="userProfile" class="easyui-validatebox" value="${tjyUser.userProfile}"  />
			    	</td>
			  </tr>
			...
			<tr>
			    	...
			    	<c:choose>
			    		<c:when test="${tjyUser.province eq p.id }">
			  ...
			  <tr style="display: none;">
			    	...
			    	<td>
			     		<input type="text" name="address" class="easyui-validatebox"  value="${tjyUser.address}"  data-options="validType:['length[1,100]']"   maxlength="40" />
			    	</td>
			  </tr>
			  <tr>
			    	<th style="width: 120px">公司：</th>
			    	<td>
			     		<input type="text" name="comName" class="easyui-validatebox"  value="${tjyUser.comName}" required="true"  data-options="validType:['length[1,100]']"   maxlength="40" />
			    	</td>
			  </tr>
			  ...
			  <tr>
			    	...
			    	<td >
			    	<select name="job"  sValue="${tjyUser.job }" style="width: 120px;">
			  ...
			  <tr>
			    	...
			    	<td >
			    	<select name="industry"   sValue="${tjyUser.industry }" style="width: 120px;">
