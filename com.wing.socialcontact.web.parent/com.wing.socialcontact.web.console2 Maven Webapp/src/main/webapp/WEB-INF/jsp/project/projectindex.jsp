...
<div id="projectindex_toolbar" class="search-div">
	<div class="search-content">
		...
		<span>
			<button class="btn btn-primary btn-small" type="button" onclick="addProject()">发布项目</button>&nbsp;
		</span>
		</shiro:hasPermission>
	</div>
</div>
	...
	$("#projectindex_datagrid").datagrid({
		...
		columns : [[
			...
			},
			{
				...
				width : 150,
				formatter: function(value, row, index){
					return   "<a href = 'javaScript:void(0)' onclick = showSignup('"+row.id+"')>咨询用户</a>|"
							+"<a href = 'javaScript:void(0)' onclick = updateProject('"+row.id+"')>编辑</a>|"
