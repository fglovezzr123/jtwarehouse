	...
	<form  action="im/update.do"  method="post" id="group_form" enctype="multipart/form-data" >
		<table class="table table-bordered">
	    	<tr>
		    	...
		    	<td style="width: 85%">
		    		<input type="text" name="groupPower" class="easyui-validatebox" required="true" maxlength="100" onkeyup="clearNoNum2(this);"   value="${imGroupinfo.groupPower}"/>
		    	</td>
		  	</tr>
		  	...
		  	<tr>
		    	...
		    	<td style="width: 85%">
		    		<input type="text" name="groupName" class="easyui-validatebox" required="true" maxlength="20" value="${imGroupinfo.groupName }"/>
		    	</td>
		  	</tr>
			<tr >
		    	<th>群标签：</th>
		  	...
		  	<tr id="to_user_ids" >
				...
				<td>
					<textarea name="users"  id="users" rows="2" style="width:95%;"  required="true">${user_names }</textarea>
				</td>
			</tr>
			<tr >
		    	<th>私密群：</th>
