...
<body style="background: #ebebeb">
  ...
  <%--   <script src="${path}/resource/js/NIM_Web_Chatroom_v4.1.0.js"></script>
	...
	var myScroll;
	var lastMSGid='';
	var myaccounts='<%=userid %>',fAccount=6196,groupid=window.location.search.split("=")[1];
	var scrolled=false;
	...
	clearUnread();
	  ...
	  function onMsg(msg) {
	      ...
	      if(msg.scene=="team" && msg.to==groupid){
	    	  nim.resetSessionUnread("team-"+groupid);
	    	  var varId=yzm();
