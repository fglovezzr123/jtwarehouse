...
<div style="width: 800px;margin: 0 auto;" >
	<form  action="news/addview.do"  method="post" id="news_form" afterCallback="saveCallback" enctype="multipart/form-data" >
		  ...
		  <table class="table table-nobordered " style="margin-top: 25px;">
		     ...
		     <tr>
			    	...
			    	<td >
			     		<input type="text" name="viewUser" class="easyui-validatebox" required="true"  data-options="validType:['length[1,10]']"   maxlength="10" />
			    	</td>
			  </tr>
			  <tr>
			    	<th style="width: 80px">专访标题：</th>
			    	<td >
			     		<input type="text" name="newsTitle" class="easyui-validatebox" style="width:480px;"  required="true"  data-options="validType:['length[1,50]']"   maxlength="50" />
			    	</td>
			  </tr>
			   <tr>
