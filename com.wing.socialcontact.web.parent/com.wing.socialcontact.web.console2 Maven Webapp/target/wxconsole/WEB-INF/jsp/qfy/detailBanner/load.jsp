...
<%@ include file="/WEB-INF/jsp/commons/include.inc.jsp"%>
		...
		<div id="${param.rel}_toolbar" class="search-div">
			<form onsubmit="return datagridSearch(this,'${param.rel }_datagrid');" >
				...
				<span>
					<label style="width: 100px;">幻灯片名称：</label>
					...
					<span style="float: left;"> 
						<shiro:hasPermission name="entryQuickDetailBanner:add">
							<a class="easyui-linkbutton" icon="icon-add" plain="true"
								href="quickDetailBanner/addPage.do?rel=${param.rel }" title="新增" target="dialog"
						...
						<shiro:hasPermission name="entryQuickDetailBanner:update">
							<a class="easyui-linkbutton" icon="icon-edit" plain="true" title="修改"
								href="quickDetailBanner/updatePage.do?id={id}&rel=${param.rel}"
						...
						<shiro:hasPermission name="entryQuickDetailBanner:delete">
							...
							href="quickDetailBanner/del.do" target="selectedTodo"  title="确定要删除吗?" warn="请至少选择一条记录">批量删除</a>
				       </shiro:hasPermission>
						</span> 
...
<script type="text/javascript">	
	...
	function loadMain(){
		$('#<%=request.getParameter("rel")%>_datagrid').datagrid(
			{
				url : "quickDetailBanner/query.do", 
				columns : [ [
						{
							field:"ck",
							title : "勾选",
