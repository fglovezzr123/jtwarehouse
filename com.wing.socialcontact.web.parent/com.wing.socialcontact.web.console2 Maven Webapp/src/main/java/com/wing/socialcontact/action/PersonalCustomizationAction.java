...
public class PersonalCustomizationAction extends BaseAction {
    ...
    public ModelAndView projectquery(PageParam param, PersonalCustomization t) {
        t.setDeleted(0);
    ...
    @ResponseBody
    public Map<String, Object> saveOrUpdateProject(PersonalCustomization t ,HttpServletRequest request) {
