...
<html>
	...
	<body style="background: #f2f3f4; width: 100%;height: 100%;">
	 <div class="meeting-search">
				<div>
					<input type="text" placeholder="搜索好友" id="keywords" onblur="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')" onpaste="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"  oncontextmenu = "value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"/>
