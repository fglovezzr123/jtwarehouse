...
<body>
<form id="dataForm" action="${path}/m/news/searchList.do" method="post">
...
$(document).ready(function() {
  ...
  $("#search").click(function(){
	  ...
	  var ss = JSON.parse(localStorage.getItem("newskeys"))||[];
      var arr = [];
      arr.push(keywords);
      ...
      localStorage.setItem("newskeys", JSON.stringify(arr));
      doSearch(keywords);
  });
...
function clearHis(){
	 ...
	 localStorage.removeItem("newskeys");
}
