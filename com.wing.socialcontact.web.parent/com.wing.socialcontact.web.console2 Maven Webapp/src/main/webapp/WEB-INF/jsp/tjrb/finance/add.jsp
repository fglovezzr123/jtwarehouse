 	 ...
 	 <%----%>
		<table class="table table-nobordered " style="margin-top: 25px;">
			...
			<tr>
				...
				<td>
					<select name="financeType" id="financeType" required="true" style="width: 120px;">
						...
						<option  value="7">商业保理</option>
						<option value="8">典当抵押</option>
						<option value="9">抵押贷款</option>
					</select>
				</td>
			  ...
			  <tr>
			    	...
			    	<td>
						<input type="text" name="interest"  style="width: 40px;"/>%
			    	</td>
			  </tr>
			  <tr>
			    	<th style="width: 120px">放款时间：</th>
			    	<td>
						<input type="text" name="lendingDate"  style="width: 40px;"/>天
			    	</td>
			  </tr>
			<tr>
				<th style="width: 120px">亮点一：</th>
				<td>
					<input type="text" name="bright1" />
				</td>
			</tr>
			<tr>
				<th style="width: 120px">亮点二：</th>
				<td>
					<input type="text" name="bright2" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<textarea id="material" name="material" rows="5" cols="35"></textarea>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<textarea name="introduce" style="width:320px;height:600px;" id="introduce"></textarea>
				</td>
			</tr>
			<tr>
