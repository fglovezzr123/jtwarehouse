...
<div class="swiper-container banner" id="banner">
   	<ul class="swiper-wrapper banner_ul" id="bannerul"  style="height:3.6rem;">
...
$(document).ready(function() {
	zdy_ajax({
		url: "${path}/m/qfy/selBannerList.do",
	    showLoading:false,
		data:{
			columnType:"<%=bannerid %>"
		},
		success: function(data,res){
			if(res.code == 0){
				...
				$.each(res.dataobj, function(i, n){
					s += '<li class="swiper-slide" onclick="openurl(\''+n.jumpUrl+'\')"><img src="'+_oss_url+n.picPath+'"  width="50%"/></li>';
				}); 
				if(s==''){
