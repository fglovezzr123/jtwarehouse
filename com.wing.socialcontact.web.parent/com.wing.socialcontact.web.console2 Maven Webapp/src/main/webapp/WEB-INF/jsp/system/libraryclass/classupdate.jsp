...
<%--
	模块：系统管理
--%>
	<form  action="libraryclass/classupdate.do"  id="libraryclass_form"  method="post"   onsubmit="return validateSubmitForm(this)">
	<input id="imagePath" name="imagePath" value="${dto.imagePath}"  type="hidden" />
		 <table class="table table-nobordered " style="margin-top: 25px;">
		  ...
		  <input type="hidden" name="position" value="${dto.position}"/>
...
$(document).ready(function(){
	...
	$("#position"+${dto.position}).attr("selected","selected");
}) ;
