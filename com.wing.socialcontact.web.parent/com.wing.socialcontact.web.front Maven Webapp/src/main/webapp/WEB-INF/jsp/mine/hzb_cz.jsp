...
<html lang="en">
	...
	<body style="background: #f2f3f4;">
		<div class="hzb-header">
	 		...
	 		<span>
	 			<c:choose>
	 				<c:when test="${user.hzbOpenFlag eq 0}">未开通</c:when>
	 				<c:when test="${user.hzbOpenFlag eq 1}">已开通</c:when>
	 				<c:when test="${user.hzbOpenFlag eq 2}">已停用</c:when>
	 				<c:when test="${user.hzbOpenFlag eq 3}">已过期</c:when>
		...
		<div class="check">
	 	...
	 	<div class="_rank">
	 		<div class="r-item">
	 			<span class="item_left">客服电话:</span>
