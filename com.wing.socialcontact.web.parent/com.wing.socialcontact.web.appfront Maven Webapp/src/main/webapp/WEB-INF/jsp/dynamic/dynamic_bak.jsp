...
<html lang="en">
	...
	<body style="background: #f2f3f4;">
		<div class="I-Pk" style="background: #f2f3f4;width: 100%;">
			...
			<audio autoplay="autoplay" id="audio_id">
				<source src="${path}/resource/img/Kalimba.mp3" type="audio/mpeg">
			</audio>
			<input type="button" id="bf_button" value="播放"/>
		</div>
		...
		function isEmojiCharacter(substring) {  
			...
			$(function(){
				...
				fb_speak_bt.addEventListener("click",function(event){
					if(startFlag){
						$(this).removeClass('fb_speak_bt');
						$(this).addClass('fb_speak_bt2');
						startRecord();
						mediaSeconds = 0;
						setHideFb_yyt();
						timedCount();
						...
						$(this).removeClass('fb_speak_bt2');
						$(this).addClass('fb_speak_bt');
						stopCount();
						stopRecord();
						$("#fb_speak_p").html("");
						setShowFb_yyt();
