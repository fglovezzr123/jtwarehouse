...
--%>
	...
	<form  action="activitytag/add.do"  id="activitytag_form"  method="post"   onsubmit="return validateSubmitForm(this)">
		...
		<div class="divider"></div>
		  <table class="table table-nobordered " style="margin-top: 25px;">
			  ...
			  <tr>
			    	...
			    	<td>
			     		<input type="text" name="name" class="easyui-validatebox" required="true"  data-options="validType:['length[1,10]']"   maxlength="10" />
			    	</td>
			  </tr>
			 <tr>
