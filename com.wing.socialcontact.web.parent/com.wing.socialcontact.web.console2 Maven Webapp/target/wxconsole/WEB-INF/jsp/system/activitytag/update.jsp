...
<%--
	模块：系统管理
--%>
	<form  action="activitytag/update.do" id="activitytag_form"  method="post"   onsubmit="return validateSubmitForm(this)">
	<input id="imagePath" name="imagePath" value="${dto.imagePath}"  type="hidden" />
		 <table class="table table-nobordered " style="margin-top: 25px;">
			  
			  <tr>
			    	<th style="width: 80px">活动分类：</th>
			    	<td >
			    	<select  name="classId">
			    	<c:choose>
			  ...
			  <tr>
			    	...
			    	<td>
			     		<input type="text" name="name" class="easyui-validatebox" data-options="required:true"  value="${dto.name}"  data-options="validType:['length[1,10]']"   maxlength="10"/>
			    	</td>
			  </tr>
			  <tr>
			  ...
			  <tr>
			    	...
			    	<td >
	                    ...
	                    <strong style="color:#F00">请上传jpg,jpeg,png格式图片,建议尺寸300*200px。</strong>      	
                	</td>
			  </tr>
			  <tr>
...
function save(){
	...
	if(flag){
		if(!validateSubmitForm($('#activitytag_form'))){
			return;
		}
	}
}
