		 ...
		 <table class="table table-nobordered " style="margin-top: 25px;">
			 <tr>
			   ...
			   <tr>
			    	...
			    	<td >
			     		<input type="text" name="topicDesc" id="topicDesc" value="${t.topicDesc}" class="easyui-validatebox" required="true"  data-options="validType:['length[1,100]']"   maxlength="100" style="width: 400px;" placeholder="抛出本次PK话题，不超过100个汉字"/>
			    	</td>
			  </tr>
			   <tr>
			    	<th style="width: 100px">红方观点：</th>
			    	<td >
			     		<input type="text" name="redPoint" id="redPoint"  value="${t.redPoint}" class="easyui-validatebox" required="true"  data-options="validType:['length[1,50]']"   maxlength="50" style="width: 400px;" placeholder="不超过50个汉字"/>
			    	</td>
			  </tr>
			   <tr>
			    	<th style="width: 100px">蓝方观点：</th>
			    	<td >
			     		<input type="text" name="bluePoint" id="bluePoint" value="${t.bluePoint}" class="easyui-validatebox" required="true"  data-options="validType:['length[1,50]']"   maxlength="50" style="width: 400px;" placeholder="不超过50个汉字"/>
			    	</td>
			  </tr>
			    <tr>
			    	<th style="width: 100px">话题阐述：</th>
			    	<td >
			     	 <textarea  name="topicExplain" id="topicExplain" rows="5" maxlength="500" style="width:400px">${t.topicExplain}</textarea>
			    	</td>
			  </tr>
			  <tr>
			   ...
			   <tr>
			    	...
			    	<td >
			     		<select name="allowComment" id="allowComment" style="width: 120px;">
			  ...
			  <tr>
			   ...
			   <tr>
			    	...
			    	<td >
			     	 <textarea  name="remark" id="remark" rows="3" maxlength="50" style="width:400px">${t.remark}</textarea>
			    	</td>
			  </tr>
			  <tr>
				 <th></th>
