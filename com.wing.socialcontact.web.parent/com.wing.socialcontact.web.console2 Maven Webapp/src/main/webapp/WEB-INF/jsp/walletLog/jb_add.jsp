...
<div style="width: 95%; margin: 0 auto;">
	<form action="walletLog/add.do" method="post"  id="walletlog_jb" onsubmit="return validateSubmitForm(this)">
		<table class="table table-bordered ">
			 ...
			 <tr>
				...
				<td width="85%">
			     	<textarea  id="remark" name="remark" rows="1" cols="100" required="required" style="width: 98%;" maxlength="200" ></textarea>
...
function save(){
	...
	if($.trim(remark).length <= 0){
		...
		if(!validateSubmitForm($('#walletlog_jb'))){
			return;
		}
	}
