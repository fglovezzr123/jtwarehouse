...
import com.wing.socialcontact.sys.model.LoginInfo;
...
import com.wing.socialcontact.sys.model.RSAPublicKeyModel;
...
public class UserAction extends BaseAction{
	...
	public String updatePage(String id,ModelMap map){
		SyUsers user=service.selectByPrimaryKey(id);
		if(user==null){
			return NODATA;
		}
	...
	public String  myInfo(ModelMap map){
		...
		SyUsers user=service.selectByPrimaryKey(me.getId());
