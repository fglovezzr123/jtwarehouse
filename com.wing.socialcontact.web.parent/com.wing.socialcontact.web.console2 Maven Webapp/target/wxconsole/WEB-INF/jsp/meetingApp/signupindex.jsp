...
<div style="display:none">
	<form id="export_mtsignup_form" action="meetingApp/signup/export.do" target="export_mtsignup_hidden_frame">
...
function showMeetingSignupDetail(obj){
	...
	MUI.openDialog('详细信息','meetingApp/signupdetail.do?id='+obj,"meetingsingupdetailpage",params)
}
function changeStatus(id){
	 $.ajax({
	 	url :"meetingApp/signup/changestatus.do", 
		type: 'post',	
		data: {id: id},
		cache: false,
		dataType:"json",
