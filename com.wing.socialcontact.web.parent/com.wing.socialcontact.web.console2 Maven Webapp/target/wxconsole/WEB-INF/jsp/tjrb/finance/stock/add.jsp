...
--%>
	...
	<form  action="financeProductStack/add.do"  id="financeProductStack_form"  method="post"   onsubmit="return validateSubmitForm(this)">
 	 <input id="projectProfileUrl" name="projectProfileUrl" value=""  type="hidden" />
		...
		<table class="table table-nobordered " style="margin-top: 25px;">
			...
			<tr>
			  ...
			  <tr>
			    	...
			    	<td>
						<input name="strengths" style="width:200px;">
			    	</td>
			  </tr>
			<!-- <tr>
			...
			<tr>
				<th>点击上传融资计划书</th>
				<td><input type="file" name="bpBookUrl"/></td>
			</tr>
			<tr>
				<th>项目路演Q&A</th>
				<td><input type="file" name="roadShowUrl"/></td>
			</tr>
			<tr>
...
function doSelectPic1() {
	...
	if(imgSize <= 0 ){
		$("#pic", $("#uploadProductPicFrame")[0].contentWindow.document).click();
	}else{
		alert("仅能上传一张图片");
	}
	return false;
...
function initUploadTagPicFrame(){
	...
	$("#uploadProductPicFrame").attr("src", frameSrc);
}
//公共方法,用来将对象转化为URL参数
...
function picChange(inputFile){
	...
	if (fileSize>2097152){
		...
		$("#upload", $("#uploadProductPicFrame")[0].contentWindow.document).submit();
	}
}
