...
--%>
	...
	<form  action="quickDoor/add.do"  id="quickDoor_form"  method="post"   onsubmit="return validateSubmitForm(this)">
		 <input id="quickImgPath" name="quickImgPath" value=""  type="hidden" />
		<div class="divider"></div>
		  <table class="table table-nobordered " style="margin-top: 25px;">
			  <tr>
			    	<th style="width: 120px">入口名称：</th>
			    	<td>
			     		<input type="text" name="quickName" class="easyui-validatebox" required="true"  data-options="validType:['length[1,20]']"   maxlength="20" />
			    	</td>
			  </tr>
		 	  ...
		 	  <tr>
			    	...
			    	<td >
                		<span id="addQuickDoorImgs" title="点击删除" ></span>
						...
						<strong style="color:#F00">请上传jpg,jpeg,png格式图片,建议尺寸100*100px。</strong>
                	</td>
			  </tr>
			  <tr>
...
function picUploadCallback(data){
	if (data.returnCode == "1"){
		...
		if(picUrl.length > 0){
    		...
    		$("#addQuickDoorImgs").append(imgHtml);
		}else{
			alert("上传失败,请稍后再试");
		}
	}else{
