					   ...
					   return;
						   ...
						   if($('#askInfo').val().length>15){
								...
								success : function(data, res) {
									layer.msg(res.msg);
									var myStore=JSON.parse(localStorage.getItem("recentContacts"));
									if(myStore){
										myStore[sessionStorage.getItem('groupNo163')].teamName=$('#askInfo').val();
										localStorage.setItem("recentContacts",JSON.stringify(myStore));
									}
									var obj={};
									obj.nickName=$('#askInfo').val();
