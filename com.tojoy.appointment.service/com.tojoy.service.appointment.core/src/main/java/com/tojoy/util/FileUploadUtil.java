...
import com.tojoy.config.OssConfig;
...
public class FileUploadUtil {
	...
	public static final String PROJECT_NAME = "tianjiu";
	/**
	 * 设置缓存30天时间
	 * @param metadata
	 */
	...
	public static String uploadFileInputStream(InputStream io, String ext,String path) {
	    ...
	    //把Bucket设置成所有人可读
        setBucketPublicReadable(client, ossConfig.getOss_bucketName());
		String key = PROJECT_NAME+"/"+path +"/"+getCurrentDate() + UUID.randomUUID() + ext;
