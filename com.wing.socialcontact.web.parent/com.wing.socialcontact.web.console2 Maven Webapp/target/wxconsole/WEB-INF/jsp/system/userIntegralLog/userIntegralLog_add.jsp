...
<div style="width: 95%; margin: 0 auto;">
	<form action="userIntegralLog/add2.do" method="post"  id="userIntegralLog_add2" onsubmit="return validateSubmitForm(this)">
		<table class="table table-bordered ">
			 ...
			 <tr>
				...
				<td width="85%">
			     	<select class="combox required" class="easyui-validatebox" required="true" id="integralType" name="integralType" >
							<option value="1">+</option>
							 <option value="2">-</option> 
					</select>
			     	<input type="text" name="integral"   required="required" class="easyui-numberbox"  maxlength="11" />
				</td>
			</tr>
			  <tr >
				<th>
...
function save_1(){
	...
	if($.trim(remark).length <= 0){
		...
		if(!validateSubmitForm($('#userIntegralLog_add2'))){
			return;
		}
	}
