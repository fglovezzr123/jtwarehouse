...
<div style="width: 98%;margin: 0 auto;" >
	<form  action="pageConfigApp/pageColumn/add.do"  method="post" id="pageColumn_form" enctype="multipart/form-data" >
		<h3>栏目基础信息</h3>
		<table class="table table-bordered">
			<tr>
				<th width="10%">栏目名称:</th>
				<td width="40%"><input type="text" name="columnName" class="easyui-validatebox" maxlength="10" /></td>
			...
			<%--<tr id="mode_1_1">
				<th>展示模板:</th>
				<td>
					<select id="showStyle" name="showStyle" class="easyui-validatebox" onchange="view_model(this);" style="width: 120px;">
					</select>
				</td>
			</tr>--%>
			<tr id="mode_2_1" style="display: none;">
				<th>元素数量:</th>
				<td>
					<input type="text" name="columnNum" id="columnNum" class="easyui-validatebox" maxlength="5" onkeyup="clearNoNum2(this);"/>
				</td>
			</tr>
			...
			<tr>
				<th>是否快速导航:</th>
				<td>
					<input type="radio" name="columnStatus" value="0" checked="checked">否
					...
					<tr>
						...
						<td>
							<a  href="" lookupGroup="content" title="元素内容链接查询" width="1000" height="500" targetBox="td" warn="请先选择显示内容">
								<input type="text" name="contentName" toName="content.name" class="easyui-validatebox" readonly="readonly"/>
		...
		<input type="hidden" name="elementValue" id="elementValue"/>
...
<div style="display: none;" id="demo">
	<table class="table table-bordered">
		...
		<tr>
			...
			<td>
				<select name="jumpType" required="required">
					<option value="1">APP原生</option>
...
function change_type(obj){
	...
	view_height = $("#yl_area").parent().height() - 10;
}
