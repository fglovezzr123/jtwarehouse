...
--%>
	...
	<form  action="quickDetailBanner/add.do"  id="quickDetailBanner_form"  method="post"   onsubmit="return validateSubmitForm(this)">
		...
		<div class="divider"></div>
		  <table class="table table-nobordered " style="margin-top: 25px;">
			  <tr>
			    	...
			    	<td>
			     		<select name="quickDoorId" id="quickDoorId" required="true" style="width: 120px;">
			  ...
			  <tr>
			    	...
			    	<td>
			     		<input type="text" name="name" class="easyui-validatebox" required="true"  data-options="validType:['length[1,30]']"   maxlength="30" />
			    	</td>
			  </tr>
			  <tr>
			    	<th style="width: 120px">幻灯片连接：</th>
			    	<td>
			     		<input type="text" name="link" class="easyui-validatebox" required="true"  data-options="validType:['length[1,255]']"   maxlength="255" />
			    	</td>
			  </tr>
			  <tr>
