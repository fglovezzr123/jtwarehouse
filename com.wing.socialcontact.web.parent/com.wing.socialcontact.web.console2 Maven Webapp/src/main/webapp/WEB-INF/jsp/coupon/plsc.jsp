...
<table class="table table-nobordered " style="margin-top: 25px;">
	<tr <c:if test="${type==4}">style="display: none"</c:if>>
			    	<th style="width: 100px">生成数量：</th>
			    	<td >
			     		<input type="text" name="couponNum"  id="couponNum" class="easyui-numberbox" <c:if test="${type!=4}">required="true"</c:if> data-options="validType:['length[1,6]']"   maxlength="6"  max="999999"/>
			    	</td>
			  </tr>
			  <tr>
