		...
		<div  class="search-content" >
			...
			<span>
				<label>登录时间：</label>
					...
					<input type="text"  readonly="readonly"  id="stime"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true,maxDate:'#F{$dp.$D(\'etime\')}'})"  name="startDate" class="span2"/>
					--
					<input type="text"  readonly="readonly"  id="etime"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true,minDate:'#F{$dp.$D(\'stime\')}'})"  name="endDate" class="span2"/>
