...
/**
 * 
 * 类名：MsgConfig 功能：消息配置文件 详细： 作者：dijuli 版本：1.0 日期：2016-4-1 上午9:46:54
 *
 */
public interface MsgConfig {
	...
	// 不能删除
	public static final String MSG_KEY_ERROR_NODEL = "msg.error.nodel";

	public static final String MSG_KEY_HASCHILD = "msg.newsClass.haschild";

	public static final String MSG_KEY_HASCOUPONLOG = "msg.error.hascouponlog";

	public static final String MSG_KEY_HASCOUPONCG = "msg.error.hascouponcg";

	public static class RELATION_STATUS {
		public static int ASKING = 1;// 请求中
		public static int AGREED = 2;// 同意
		public static int REJECT = 3;// 拒绝
	}
