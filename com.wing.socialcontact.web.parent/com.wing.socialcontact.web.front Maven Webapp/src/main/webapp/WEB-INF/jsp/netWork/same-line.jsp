...
// 				  				}   
		  					  ...
		  					  for(var i=0;i<data.length;i++){
		  								...
		  								success : function(data, res) {
		  									if ('0'==res.dataobj) {
		  										...
		  										zdy_ajax({
		  											...
		  											success : function(data, res) {
		  												if ('0'==res.dataobj) {
		  			  			  					    	window.location.href="${path}/wx/businessFriend/applyToAddGroup.do?follow_user="+that.attr('id');
		  					    ...
		  					    $('.belongItem').bind('click',function(){
                                     var that = $(this)
                                     window.location.href="${path}/wx/businessFriend/friendInfo.do?follow_user="+that.find('.iconsssss').attr('userId');
		  							...
		  							/*zdy_ajax({
		  								...
		  								success : function(data, res) {
		  									...
		  									//判断接收好友数是否达到每天上限
		  										zdy_ajax({
		  											url : _path+"/im/m/is_getFriend_max2.do?follow_user="+that.find('.iconsssss').attr('userId'),
		  											type : 'post',
		  											dataType : 'json',
		  											success : function(data, res) {
		  												if ('0'==res.dataobj) {
