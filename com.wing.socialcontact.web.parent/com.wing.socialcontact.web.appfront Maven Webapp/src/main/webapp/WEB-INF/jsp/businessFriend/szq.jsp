...
<html>
	...
	<body>
		<div class="wrapper">
			<div class="content" style="margin-top: 0;">
				...
				<div class="content-item bottom-border active_A clear">
					...
					<div class="con-r"><input type="text" name="" id="qm" value="" placeholder="请填写群名称" onkeyup="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')" onpaste="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"  oncontextmenu = "value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')" /></div>
				</div>
		...
		<script type="text/javascript">
			...
			$('#qm').on('input',function(){
				 var qm = $(this).val(); //群组名称 */
				 if(qm.length>15){
					   layer.msg("请输入1-15个字符")
					   $(this).val(qm.slice(0,15))
					   return
			    }
			})
