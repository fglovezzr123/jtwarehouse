...
<div style="width: 800px;margin: 0 auto;" >
	<form  action="news/hotupdate.do"   method="post"   id="news_form"  afterCallback="saveCallback" enctype="multipart/form-data" >
		 ...
		 <table class="table table-nobordered " style="margin-top: 25px;">
			  <tr>
			    	...
			    	<td>
			     		<input type="text" name="newsTitle" class="easyui-validatebox" data-options="required:true"  value="${n.newsTitle}" data-options="validType:['length[1,30]']"   maxlength="30" />
			    	</td>
			  </tr>
			 <!--  <tr>
			    	<th style="width: 80px">标题链接：</th>
			    	<td>
			     		<input type="text" name="url"  id="url" class="easyui-validatebox" disabled="true" required="true"  data-options="validType:['length[1,100]']"   maxlength="100" style="width:500px;"/>
