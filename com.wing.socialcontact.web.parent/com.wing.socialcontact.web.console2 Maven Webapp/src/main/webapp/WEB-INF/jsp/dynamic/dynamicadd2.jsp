...
<form method="post" action="" id="dataForm">
	...
	<table class="table table-bordered" style="margin-top:0px;width:99%;">
		<tr>
			<th style="width:15%;">广告内容<font color="red">*</font>：</th>
			<td colspan=3>
		...
		<tr>
			<th style="width:15%;">动态广告Url<font color="red">*</font>：</th>
			<td colspan=3>
				<input style="width:95%" id="ad_url" name="adUrl">
				<input type="hidden" id="dy_type" name="dyType" value="1">
			</td>
		</tr>
		<tr id="zdyh_tr_2">
		    	<th>是否好友可见：</th>
