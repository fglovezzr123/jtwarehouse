					...
					<div id="layout_north_gryhMenu"	style="width:150px;display: none;">
						...
						<div>
							...
							<div style="width:150px;">
								...
								<div onclick="MUI.openCenterTab('登录日志','log/login/my.do?rel=grbg_grse_log','grbg_grse_log',false,true)">登录日志</div>
								<div onclick="MUI.openCenterTab('登录管理','user/my/loginInfo.do?rel=main_login_info','main_login_info',false,true)">登录管理</div>
