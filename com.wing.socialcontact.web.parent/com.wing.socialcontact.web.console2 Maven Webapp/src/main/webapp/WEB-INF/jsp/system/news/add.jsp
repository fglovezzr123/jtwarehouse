...
<div style="width: 800px;margin: 0 auto;" >
	<form  action="news/add.do"  method="post" id="news_form" afterCallback="saveCallback" enctype="multipart/form-data" >
		  ...
		  <table class="table table-nobordered " style="margin-top: 25px;">
			 ...
			 <tr>
			    	...
			    	<c:if test="${param.typename=='0'||param.typename=='资讯'}">
			    	   <input type="text" readonly="readonly"  toName="newsclass.name"  class="easyui-validatebox" required="true" value="选择分类"/>
			    	</c:if>
					<c:if test="${param.typename!='0'&&param.typename!='资讯'}">
			    	   <input type="text" readonly="readonly"  toName="newsclass.name"  class="easyui-validatebox" required="true" value="${param.typename}"/>
			    	</c:if>		
					</a>
						<input type="hidden" name="types"   id="types" toName="newsclass.id"  value="${param.types}"/>
			       </td>
			  </tr>
			   <tr>
			 ...
			 <!--  <tr>
			    	...
			    	<td >
			     		<input type="text" name="charge" class="easyui-numberbox"   maxlength="10" />
			    	</td>
			  </tr> -->
			  <tr>
