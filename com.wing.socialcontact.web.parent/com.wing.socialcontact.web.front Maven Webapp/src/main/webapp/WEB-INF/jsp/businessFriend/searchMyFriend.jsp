...
<html>
	...
	<body style="background: #f2f3f4; width: 100%;height: 100%;">
	          <div class="meeting-search">
				<div>
					<input type="text" placeholder="商友搜索" id="keywords" onblur="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')" onpaste="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"  oncontextmenu = "value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"/>
			...
			success: function(data,res){
				...
				if(data.friendList.length == 0){
					...
					$.each(data.friendList,function(index){
						...
						var honor_flag = data.friendList[index].honor_flag,tjIdImg="";
