...
<html lang="en">
	...
	<body style="background: #f2f3f4;">
		<div class="rmbCharge1">充值J币</div>
		<div class="rmbCharge"><input type="text" name="je" id="je" value="" placeholder="请输入充值金额" onkeyup="this.value=this.value.replace(/\D/g,'');" onafterpaste="this.value=this.value.replace(/\D/g,'');" maxlength="8"/></div>
		<c:choose>
			<c:when test="${empty jb_rmb_show }">
				<div class="rmbCharge2">当前J币兑换比例尚未设置，不能充值，请联系客服人员</div>
			</c:when>
			<c:otherwise>
				<div class="rmbCharge2">当前J币兑换比例 ${jb_rmb_show}</div>
