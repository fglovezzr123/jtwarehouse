			...
			<form onsubmit="return datagridSearch(this,'${param.rel }_datagrid');" >
				...
				<div class="search-toolbar">
					<span style="float: left;"> 
						<shiro:hasPermission name="entryServiceTag:add">
							<a class="easyui-linkbutton" icon="icon-add" plain="true"
								href="entryServiceTag/addPage.do?rel=${param.rel }" title="新增" target="dialog"
								width="600" height="400" rel="${param.rel}_add"><span>新增</span>
							</a>
						</shiro:hasPermission> 
						<shiro:hasPermission name="entryServiceTag:update">
							<a class="easyui-linkbutton" icon="icon-edit" plain="true" title="修改"
								href="entryServiceTag/updatePage.do?id={id}&rel=${param.rel}"
								target="dialog" width="600" height="400"
								rel="${param.rel}_update" warn="请先选择一条记录"><span>修改</span>
							</a>
						</shiro:hasPermission>
						<shiro:hasPermission name="entryServiceTag:delete">
					   		<a  class="easyui-linkbutton"  icon="icon-remove"	plain="true"
						href="entryServiceTag/del.do" target="selectedTodo"  title="确定要删除吗?" warn="请至少选择一条记录">批量删除</a>
				       </shiro:hasPermission>
						</span> 
