...
function commons(){
  ...
  if(window.location.href.indexOf('talkAbout')>-1 || window.location.href.indexOf('talkAboutQl')>-1 ){
	  console.log("公共IM不再执行");
	  return;
  }

  if(!localStorage.getItem("currentUserId") || !localStorage.getItem("mytoken")){
      return;
   }
  ...
  nim = new NIM({
    ...
    // debug: true
      ...
      account: localStorage.getItem("currentUserId"),
