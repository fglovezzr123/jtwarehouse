	  ...
	  <input value="${bean.id}" name="id" type="hidden"/>
			<table class="table table-nobordered " style="margin-top: 25px;">
				...
				<tr>
					...
					<td>
						<select name="crowdType" id="crowdType" required="true" style="width: 120px;">
							<<option value="1" <c:if test="${bean.crowdType==1}">selected</c:if>>儿童</option>
							<option value="2" <c:if test="${bean.crowdType==1}">selected</c:if>>成人</option>
							<option value="3" <c:if test="${bean.crowdType==1}">selected</c:if>>老人</option>
							<option value="4" <c:if test="${bean.crowdType==1}">selected</c:if>>家庭</option>
						</select>
					</td>
				...
				<tr>
					...
					<td>
						<input type="text" name="strengths1"  value="${bean.strengths1}"/>
					</td>
				</tr>
				<tr>
					<th style="width: 120px">亮点2：</th>
					<td>
						<input type="text" name="strengths2" value="${bean.strengths2}" />
					</td>
				</tr>
				<tr>
					<th style="width: 120px">亮点3：</th>
					<td>
						<input type="text" name="strengths3" value="${bean.strengths3}" />
					</td>
				</tr><tr>
					<th style="width: 120px">亮点4：</th>
					<td>
						<input type="text" name="strengths4" value="${bean.strengths4}"/>
					</td>
				</tr>
				<tr>
					<th style="width: 120px">起购金额：</th>
					<td>
						<input type="text" name="startPoint" value="${bean.startPoint}" style="width: 40px;" />
					</td>
				</tr>
				<tr>
					<th style="width: 120px">最高保额：</th>
					<td>
						<input type="text" name="expectedReturn" value="${bean.expectedReturn}" style="width: 40px;" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						...
						<strong style="color:rgb(240, 16, 16)">请上传jpg,jpeg,png格式图片,建议尺寸640*320px，大小限制2M。</strong>
					</td>
				</tr>
				<tr>
					<th style="width: 120px">职务：</th>
					<td>
						<input type="text" name="consultant" value="${bean.consultant}" required="true" min="1" max="9999" />
					</td>
				</tr>
				<tr>
					<th></th>
