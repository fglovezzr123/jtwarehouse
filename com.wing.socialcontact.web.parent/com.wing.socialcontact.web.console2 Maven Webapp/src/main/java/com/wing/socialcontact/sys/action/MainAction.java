...
public class MainAction extends BaseAction{
	...
	public String to(ModelMap map){
		...
		//查询出顶部一级菜单
		map.addAttribute("menus",service.selectMenusTop(ServletUtil.getMember().getId()));
	    //查询出用户的自定义快捷菜单
	...
	public ModelAndView clearRedis(ModelMap map){
		mainService.clearRedis();
