...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="快速登录">
        <title>快速登录</title>
    ...
    <body>
    	<div class="Z-register-login" style="background: #f2f3f4;width: 100%;height: 100%;">
	       	<div class="Z-content">
	       		...
	       		<div class="cphone">
	       			<img src="${path}/resource/img/icons/rs_03.png"/>
	       			<input type="number" id="mobile" name="mobile" class="phone pz" placeholder="请输入常用的手机号注册" oninput="if(value.length>=11){value=value.slice(0,11)}"/>
	       		</div>
	       		<%-- <div class="cphone">
	       	...
	       	<button class="btn-z active_A" onclick="reg();">立即登录</button>
     		<div class="btn btnnobg" style="display: none;"><a href="${path}/m/sys/loginPage.do">已有账号登录>></a></div>
     		<div class="tip" ><input type="checkbox" name="jq" id="jq" value="" checked="checked"><span>我已同意并阅读<a href="${path}/wx/register/userLog.do">《用户注册协议》</a></span></div>
     		
     		<div id="status_line" style="text-align: center;background-color: #ccc;color: #fff;width: 6.9rem;margin: .55rem .20rem 0 .30rem;height: .60rem;line-height: .60rem;display: none;font-size: .3rem">请勾选已经阅读注册协议后，才可完成注册</div>
	    </div>
