...
<html lang="en">
	...
	<body style="background: #f2f3f4;">
		<div class="msg" style="background:none;padding:0.3rem;">
		
		    <c:if test="${not empty userGreetings.answermessage}">
				<textarea id ="answermessage" name="" rows=""  disabled="disabled" cols="" style="background:#fff;padding:0.2rem;">${userGreetings.answermessage}</textarea>
		    </c:if>
		    <c:if test="${empty userGreetings.answermessage}">
				<textarea id ="answermessage" name="" rows=""  disabled="disabled" cols="" placeholder="尚未回复" style="background:#fff;padding:0.2rem;"></textarea>
		    </c:if>
		</div>
