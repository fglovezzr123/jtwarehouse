...
<div style="width: 95%; margin: 0 auto;">
	<form action="userEmpirical/${operateMethod}.do" method="post" id="empirical_form" enctype="multipart/form-data" onsubmit="return validateSubmitForm(this)">
		<table class="table table-bordered ">
			...
			<tr>
				...
				<td width="85%" colspan="3">
					<input type="text"  id="level" name="level"   required="true"  maxlength="20" value="${dto.level}"/>
				</td>
			</tr>
			<tr >
				<th>
				...
				<td width="85%" colspan="3">
					<input type="text"  id="empiricalLow" name="empiricalLow"   required="true"  class="easyui-numberbox"  maxlength="8" value="${dto.empiricalLow}"/>~
					<input type="text"  id="empiricalHigh" name="empiricalHigh"   required="true"   class="easyui-numberbox"  maxlength="8"  value="${dto.empiricalHigh}"/>
				</td>
			</tr>
			<tr>
				<th width="15%">
				...
				<td width="85%" colspan="3">
					<input type="text"  id="integralTotal" name="integralTotal"   required="true"  class="easyui-numberbox"  maxlength="8" value="${dto.integralTotal}"/>
				</td>
			</tr>
			...
			<input type="hidden" name="currentCallback" value="close" />
				...
				<c:if test="${dto.id!=null}">
					...
					<input type="hidden" name="greetingsCount" value="${dto.greetingsCount}" />	
...
function save(){
	...
	if(!validateSubmitForm($('#empirical_form'))){
		return;
	}
}
</script>