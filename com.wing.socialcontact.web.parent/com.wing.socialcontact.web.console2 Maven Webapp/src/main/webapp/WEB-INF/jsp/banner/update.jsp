		 ...
		 <table class="table table-nobordered " style="margin-top: 25px;">
			   ...
			   <tr>
		    	...
		    	<td style="width:80%">
		    		<select name="userRange" id="userRange" class="easyui-validatebox" required="true" style="width: 120px;">
		     			<option value="1" <c:if test="${b.userRange==1}">selected</c:if>>全部</option>
		     			<option value="2" <c:if test="${b.userRange==2}">selected</c:if>>指定用户</option>
		     		</select>
		    	</td>
		  	</tr>
			<tr id="zdyh_tr_1">
			...
			<tr id="zdyh_tr_2">
			  ...
			  <tr>
			    	...
			    	<td >
			     		<input type="text" name="jumpUrl" id="jumpUrl" value="${b.jumpUrl}" class="easyui-validatebox"  data-options="validType:['length[0,150]']"   maxlength="150" />
			  ...
			  <tr>
				    ...
				    <td style="width:80%">
						<select name="jumpType" id="jumpType" class="easyui-validatebox" required="true" style="width: 120px;">
							<option value="0" <c:if test="${b.jumpType==0}">selected</c:if>>无</option>
							<option value="1" <c:if test="${b.jumpType==1}">selected</c:if>>H5</option>
							<option value="2" <c:if test="${b.jumpType==2}">selected</c:if>>native</option>
						</select>
				    </td>
			  </tr>
			  <tr>
			    	...
			    	<td >
			     		<input type="text" name="orderNum" value="${b.orderNum}" class="easyui-numberbox" required="true"   maxlength="3" min="0" max="999"/>
			    	</td>
			  </tr>
			  <tr>
				 <th></th>
...
$(function() {
	var userRange = '${b.userRange}';
	if(userRange=="1"||userRange=="0"){
		$("tr[id^='zdyh_tr_']").hide();
	}
