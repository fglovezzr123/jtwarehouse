...
public class ImFriendAction extends BaseAction{
	...
	public @ResponseBody Map selMyFriendList(HttpServletRequest request,String pageNum, String pageSize,String isAll,String nickname,String userId) throws IOException{
		...
		if(StringUtil.isEmpty(isAll)|| StringUtil.isEmpty(pageNum) || StringUtil.isEmpty(pageSize) || !com.wing.socialcontact.util.StringUtil.isNumeric(pageNum) || !com.wing.socialcontact.util.StringUtil.isNumeric(pageSize)){
			return super.getAjaxResult(Constants.AJAX_CODE_ERROR_PARAM, "参数无效，请检查！", "");
		}else{
			try{
				List performs = imFriendService.findMyFriendListByUserId(userId, Integer.parseInt(pageNum), Integer.parseInt(pageSize),isAll,nickname);
	...
	public @ResponseBody Map selMyFriendList1(HttpServletRequest request,String pageNum, String pageSize,String isAll,String nickname,String userId) throws IOException{
		...
		if(StringUtil.isEmpty(isAll)|| StringUtil.isEmpty(pageNum) || StringUtil.isEmpty(pageSize) || !com.wing.socialcontact.util.StringUtil.isNumeric(pageNum) || !com.wing.socialcontact.util.StringUtil.isNumeric(pageSize)){
			...
			try{
				List performs = imFriendService.findMyFriendListByUserId1(userId, Integer.parseInt(pageNum), Integer.parseInt(pageSize),isAll,nickname);
				return super.getSuccessAjaxResult("获取成功！", performs);
			}catch(Exception e){
				return super.getAjaxResult(Constants.AJAX_CODE_ERROR_INFO, e.getMessage(), "");
			}
	...
	public @ResponseBody Map selMyFriendList2(HttpServletRequest request,String pageNum, String pageSize,String nickname,String userId) throws IOException{
		...
		if( StringUtil.isEmpty(pageNum) || StringUtil.isEmpty(pageSize) || !com.wing.socialcontact.util.StringUtil.isNumeric(pageNum) || !com.wing.socialcontact.util.StringUtil.isNumeric(pageSize)){
			...
			try{
				List performs = imFriendService.findMyFriendListByUserId2(userId, Integer.parseInt(pageNum), Integer.parseInt(pageSize),nickname);
				return super.getSuccessAjaxResult("获取成功！", performs);
			}catch(Exception e){
				return super.getAjaxResult(Constants.AJAX_CODE_ERROR_INFO, e.getMessage(), "");
			}
	...
	public  @ResponseBody Map delMyFriendByFriendUserid(HttpServletRequest request,String friendUserId) throws IOException{
	...
	public  @ResponseBody Map selTopFriendAndTopGroupListByUserId(HttpServletRequest request,String pageNum, String pageSize) throws IOException{
		...
		if(StringUtil.isEmpty(pageNum) || StringUtil.isEmpty(pageSize) || !com.wing.socialcontact.util.StringUtil.isNumeric(pageNum) || !com.wing.socialcontact.util.StringUtil.isNumeric(pageSize)){
			...
			try{
				List topUserList = imToprelatService.findTopFriendListByUserId(userId, Integer.parseInt(pageNum),Integer.parseInt(pageSize));
				List topGgroupList = imToprelatService.findTopGroupListByUserId(userId, Integer.parseInt(pageNum),Integer.parseInt(pageSize));
				Map map = new HashMap();
	...
	public  @ResponseBody Map updateFriendUserfriendMemo(HttpServletRequest request,String imFriendId, String friendMemo) throws IOException{
	...
	public  @ResponseBody Map updateFriendUserDisturb(HttpServletRequest request,String friendUserId, String distrubFlag) throws IOException{
	
		String userId =  super.checkLogin(request);
		if(userId == null || "".equals(userId))	{
			return super.getAjaxResult(Constants.AJAX_CODE_ERROR_NOTLOGIN, "未登录，请重新登录！", "");
		}	
		if(StringUtil.isEmpty(friendUserId) || StringUtil.isEmpty(distrubFlag) || (!"0".equals(distrubFlag) && !"1".equals(distrubFlag))){
			return super.getAjaxResult(Constants.AJAX_CODE_ERROR_PARAM, "参数无效，请检查！", "");
		}else{
	...
	public @ResponseBody Map selCommonFriendList(HttpServletRequest request,String aUserId,String pageNum, String pageSize) throws IOException{
		
		String userId =  super.checkLogin(request);
		if(userId == null || "".equals(userId))	{
			return super.getAjaxResult(Constants.AJAX_CODE_ERROR_NOTLOGIN, "未登录，请重新登录！", "");
		}	
		if(StringUtil.isEmpty(aUserId)|| StringUtil.isEmpty(pageNum) || StringUtil.isEmpty(pageSize) || !com.wing.socialcontact.util.StringUtil.isNumeric(pageNum) || !com.wing.socialcontact.util.StringUtil.isNumeric(pageSize)){
			return super.getAjaxResult(Constants.AJAX_CODE_ERROR_PARAM, "参数无效，请检查！", "");
		}else{
			try{
	...
	public  @ResponseBody Map updateFriendUserIsTop(HttpServletRequest request,String friendUserId, String status) throws IOException{
	
		String userId =  super.checkLogin(request);
		if(userId == null || "".equals(userId))	{
			return super.getAjaxResult(Constants.AJAX_CODE_ERROR_NOTLOGIN, "未登录，请重新登录！", "");
		}	
		if(StringUtil.isEmpty(friendUserId) || StringUtil.isEmpty(status) || (!"0".equals(status) && !"1".equals(status))){
			return super.getAjaxResult(Constants.AJAX_CODE_ERROR_PARAM, "参数无效，请检查！", "");
		}else{
			try{
	...
	public  @ResponseBody Map UpdateStarFlagByFriendUserid(HttpServletRequest request,String friendUserId, String starFlag) throws IOException{
	
		String userId =  super.checkLogin(request);
		if(userId == null || "".equals(userId))	{
			return super.getAjaxResult(Constants.AJAX_CODE_ERROR_NOTLOGIN, "未登录，请重新登录！", "");
		}	
		if(StringUtil.isEmpty(friendUserId) || StringUtil.isEmpty(starFlag) || (!"0".equals(starFlag) && !"1".equals(starFlag))){
			return super.getAjaxResult(Constants.AJAX_CODE_ERROR_PARAM, "参数无效，请检查！", "");
		}else{
			try{
	...
	public  @ResponseBody Map initUser(HttpServletRequest request) throws IOException{
		...
		imFriendService.initUsers(9,1000);
