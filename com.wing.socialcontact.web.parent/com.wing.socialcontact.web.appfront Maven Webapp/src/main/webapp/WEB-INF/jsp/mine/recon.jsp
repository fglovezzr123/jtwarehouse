...
<html lang="en">
	...
	<body>
		<div class="Z-register-login" style="background: #f2f3f4;width: 100%;padding-bottom:1rem;">
			<div class="Z-item">
				<span>姓名</span>
				<input type="text" id="trueName" name="trueName" value="" class="name" placeholder="请输入你的姓名" maxlength="10" onkeyup="clearEmojiCharacter(this);"/>
			</div>
			<div class="Z-item" style="height:auto">
				<span>公司名称</span>
				<input style="height:auto;width:70%" type="text" id="comName" name="comName" value="" class="name" placeholder="请输入公司的名称" maxlength="50" onkeyup="clearEmojiCharacter(this);"/>
			</div>
			<div class="Z-item">
				<span>职位</span>
			...
			<div class="Z-item">
				<span>注册资金(万元)</span>
				<input type="text" id="reconCapital" name="reconCapital" class="name" placeholder="请输入注册资金" maxlength="4" onkeyup="clearNoNum2(this);"/>
			</div>
			<div class="Z-item">
				<span>行业</span>
