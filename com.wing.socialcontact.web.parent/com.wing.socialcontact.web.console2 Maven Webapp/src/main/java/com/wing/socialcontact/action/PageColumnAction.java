 ...
 */
@Controller
@RequestMapping("/pageConfig/pageColumn")
public class PageColumnAction extends BaseAction {
	 ...
	 */
	@RequiresPermissions("page:add")
	@RequestMapping("lookupactivity")
	public String lookupactivity(ModelMap map, String pid) {
		return "page/pageColumn/lookupactivity";
	}
	 ...
	 */
	@RequiresPermissions("page:add")
	@RequestMapping("lookupbanner")
	public String lookupbanner(ModelMap map, String pid) {
		return "page/pageColumn/lookupbanner";
	}
	 ...
	 */
	@RequiresPermissions("page:add")
	@RequestMapping("lookupproject")
	public String lookupproject(ModelMap map, String pid) {
		return "page/pageColumn/lookupproject";
	}
	 ...
	 */
	@RequiresPermissions("page:add")
	@RequestMapping("lookupmeeting")
	public String lookupmeeting(ModelMap map, String pid) {
		return "page/pageColumn/lookupmeeting";
	}
	...
	public String lookupuser(ModelMap map, String pid) {
		...
		return "page/pageColumn/lookupuser";
	}
	 ...
	 */
	@RequiresPermissions("page:add")
	@RequestMapping("lookupnews")
	public String lookupnews(ModelMap map, String pid) {
		return "page/pageColumn/lookupnews";
	}
	 ...
	 */
	@RequiresPermissions("page:add")
	@RequestMapping("lookuptopic")
	public String lookuptopic(ModelMap map, String pid) {
		return "page/pageColumn/lookuptopic";
	}
	 ...
	 */
	@RequiresPermissions("page:add")
	@RequestMapping("lookupbusiness")
	public String lookupbusiness(ModelMap map, String pid) {
		return "page/pageColumn/lookupbusiness";
	}
	 ...
	 */
	@RequiresPermissions("page:add")
	@RequestMapping("lookuplibrary")
	public String lookuplibrary(ModelMap map, String pid) {
		return "page/pageColumn/lookuplibrary";
	}
	 ...
	 */
	@RequiresPermissions("page:add")
	@RequestMapping("lookupreward")
	public String lookupreward(ModelMap map, String pid) {
		return "page/pageColumn/lookupreward";
	}
}
