...
<%
	...
	System.out.println("登录超时===url:"+request.getRequestURI());
	System.out.println("登录超时===accept:"+accept);
	if(accept==null){
		isJson=true;
	}else{
...
<body>	
	<div id="maindiv" style="margin: 0px;font-size: 16px;	font-family: 楷体,sans-serif;width: 100%;	height: 100%;  ">
		...
		<div style="margin: 200px auto; 
		    ...
		    margin-bottom: 30px;
		    padding: 60px;">
			<span style="font-weight: bold;">登录超时！<a href="sy_login.do">重新登录</a></span>
		</div>
	...
	<!--
		if(typeof(androidWebObject) != "undefined"){
			...
			document.getElementById("maindiv").innerHTML="<span style='color:red'>登录超时</span>";
		}else{
