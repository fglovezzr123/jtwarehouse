...
<div style="width: 800px;margin: 0 auto;" >
	<form  action="honor/add.do"  method="post" id="news_form" afterCallback="saveCallback" enctype="multipart/form-data" >
		  <input id="picPath" name="picPath" value=""  type="hidden" />
		  <input id="picPath2" name="picPath2" value=""  type="hidden" />
		  <table class="table table-nobordered " style="margin-top: 25px;">
			  ...
			  <tr>
			    	...
			    	<td >
                		<span id="nimgs2" title="点击删除" ></span>
                	   	<input  onclick="doSelectPic2()"  type="button" value="上传图片" id="picturefile2" class="form_shangchuan" />
			   ...
			   <tr>
			    	...
			    	<td >
			     	    <select class="combox required" class="easyui-validatebox" required="true" id="hornorType" name="hornorType" >
			  ...
			  <tr>
			    	...
			    	<td >
			     		<input type="text" name="honorCode" class="easyui-validatebox" required="true"   />
			    	</td>
			  </tr>
			  <tr>
			...
			<!--   <tr>
			    	<th style="width: 120px">勋章触发条件：</th>
			    	<td >
			     		<input type="text" name="honorConfig" class="easyui-validatebox" required="true"  />
			    	</td>
			  </tr> -->
			  ...
			  <tr>
			    	...
			    	<td >
			     		<input type="text" name="orderNum" class="easyui-numberbox" required="true"   maxlength="20" />
			    	</td>
			  </tr>
			   <tr>
			    	<th style="width: 120px">勋章详情：</th>
			    	<td>
					<textarea id="remark" name="remark" style="width:320px;height:600px;"></textarea>
			    	</td>
			  </tr>
