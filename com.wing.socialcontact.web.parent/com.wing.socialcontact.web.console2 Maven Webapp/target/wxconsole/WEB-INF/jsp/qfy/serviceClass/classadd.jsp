...
--%>
	...
	<form  action="entryServiceClass/add.do"  method="post"   onsubmit="return validateSubmitForm(this)">
		  ...
		  <div  style="margin-left: 20px;margin-top: 10px">
				<c:choose>
					...
					<h4><p class="text-info">添加分类：上级分类为：<span style="color: red">[ <c:out  value="${param.className }" /> ]</span></p></h4>
