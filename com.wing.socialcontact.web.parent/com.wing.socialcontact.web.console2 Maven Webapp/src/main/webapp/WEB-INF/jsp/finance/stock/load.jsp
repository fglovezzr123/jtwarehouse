					...
					<span style="float: left;"> 
						<%--<shiro:hasPermission name="entryQuickDetailBanner:add">--%>
							<a class="easyui-linkbutton" icon="icon-add" plain="true"
								href="financeProductStack/addPage.do?rel=${param.rel }" title="新增" target="dialog"
						...
						<%--<shiro:hasPermission name="entryQuickDetailBanner:update">--%>
							<a class="easyui-linkbutton" icon="icon-edit" plain="true" title="修改"
								href="financeProductStack/updatePage.do?id={id}&rel=${param.rel}"
						...
						<%--<shiro:hasPermission name="entryQuickDetailBanner:delete">--%>
							...
							href="financeProductStack/del.do" target="selectedTodo"  title="确定要删除吗?" warn="请至少选择一条记录">批量删除</a>
				       <%--</shiro:hasPermission>--%>
						</span> 
...
//        alert("1111");
		$('#financeProductStack_datagrid').datagrid(
			{
				url : "financeProductStack/query.do",
				columns : [ [
						{
							field:"ck",
							title : "勾选",
