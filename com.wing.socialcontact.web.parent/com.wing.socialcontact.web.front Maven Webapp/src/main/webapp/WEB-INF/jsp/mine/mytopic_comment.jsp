    ...
    <body>
        ...
        <c:forEach  var="subComment" items="${commentList}" >
            <c:if test="${!empty subComment.fkMap}">
             <a href="${path}/m/topic/detailPage.do?id=${subComment.fkMap.id}"><div class="print-activity">
                 <h3>
                   <i>${subComment.fkMap.topicDesc}</i> <span><fmt:formatDate value='${subComment.fkMap.createTime}' pattern='yyyy-MM-dd HH:mm:ss'/></span>
                 </h3>
                 <p>
