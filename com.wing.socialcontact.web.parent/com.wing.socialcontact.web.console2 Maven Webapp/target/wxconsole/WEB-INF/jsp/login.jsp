...
<head>
	...
	<script src="resource/js/security/security.js?1=1"></script>
	<script src="resource/js/login.js?1=1"></script>
</head>
			...
			<div class="loginBar">
				...
				<div id="divcenter_loginin" style="display: none;">
					<div style="margin-left: 80px;margin-top: 40px;">
						<img src="resource/images/onload.gif" alt="正在登录中..." style="margin-left: 40px;"/>
						<div style="margin-top: 20px;margin-left:10px;font-size: 20px;font-family: 楷体">正在登录，请稍等...</div>
					</div>
				</div>
