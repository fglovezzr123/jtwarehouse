...
<div style="width: 500px;margin: 0 auto;" >
	<form  action="business/updateClass.do"   method="post"   id="news_form" afterCallback="saveCallback" enctype="multipart/form-data">
		  <input id="imagePath" name="imagePath" value="${b.imagePath}"  type="hidden" />
		 ...
		 <table class="table table-nobordered " style="margin-top: 25px;">
			  <tr>
			    	...
			    	<td>
			     		<input type="text" name="className" class="easyui-validatebox" data-options="required:true"  value="${b.className}"/>
			    	</td>
			  </tr>
			  <tr>
			    	<th style="width: 80px">序号：</th>
			    	<td>
			     		<input type="text" name="classNum" value="${b.classNum}"  class="easyui-numberbox" required="true"    maxlength="3" max="999"/>
			    	</td>
			  </tr>
			  <tr>
