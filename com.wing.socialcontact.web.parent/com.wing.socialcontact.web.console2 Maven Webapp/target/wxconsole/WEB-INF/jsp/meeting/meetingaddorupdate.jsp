...
function uploadImg(type){
	...
	/*
	if(imgType=="hb"){
		uploader.options.server = "meeting/uploadpic.do?x-oss-process=style/YSMAX640";
	}else if(imgType=="guest"){
		uploader.options.server = "meeting/uploadpic.do?x-oss-process=style/YSMAX200";
	}else{
		uploader.options.server = "meeting/uploadpic.do";
	}
	*/
...
function initWebUpload(){
	uploader = WebUploader.create({
		auto: true,
	    server: "meeting/uploadpic.do?moduleName=meeting",
	    pick: "#filePicker",
...
var validate = [
   ...
   {id: "mau_place", text: "请填写详细地址",type:"text"},
...
function save(){
    ...
    $.ajax({
		url:"meeting/meetingsaveorupdate.do",
		type: 'post',	
...
function addProjDialog(){
	...
	MUI.openDialog('项目选择','meeting/projet/index.do?id=',"projectindexformeeting",params)
}
//选择直播视频
