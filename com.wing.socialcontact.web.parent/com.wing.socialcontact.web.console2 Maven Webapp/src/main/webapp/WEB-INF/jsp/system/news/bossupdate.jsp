...
<div style="width: 800px;margin: 0 auto;" >
	<form  action="news/updateBoss.do"   method="post"   id="news_form"  afterCallback="saveCallback" enctype="multipart/form-data" >
		 ...
		 <table class="table table-nobordered " style="margin-top: 25px;">
			  <tr>
			    	<th style="width: 80px">文档标题：</th>
			    	<td>
			     		<input type="text" name="newsTitle" class="easyui-validatebox" data-options="required:true"  value="${n.newsTitle}" data-options="validType:['length[1,50]']"   maxlength="50" />
			    	</td>
			  </tr>
			  <tr>
			   ...
			   <tr>
			    	...
			    	<td >
	                    ...
	                    <strong style="color:#F00">请上传小于2M的PNG、JPG、JPEG格式图片,建议尺寸640*320px。</strong>    	
                	</td>
			  </tr>
			  <tr>
			  ...
			  <tr>
			   ...
			   <tr>
				<th style="width: 80px">是否收费：</th>
		    	<td>
		    		<select name="isFree" id="isFree" class="easyui-validatebox" required="true" style="width: 120px;">
		     			<option value="1" <c:if test="${n.isFree==1}">selected</c:if>>是</option>
		     			<option value="2" <c:if test="${n.isFree==2}">selected</c:if>>否</option>
		     		</select>
		    	</td>
		  	</tr>
			  <tr id="sfjb_tr_1">
			    	...
			    	<td >
			     		<input type="text" name="charge" id="charge" class="easyui-numberbox" value="${n.charge}"  maxlength="8" min="1" max="99999999"/>
			   </td>
			   </tr>
			  <tr>
				 <th></th>
