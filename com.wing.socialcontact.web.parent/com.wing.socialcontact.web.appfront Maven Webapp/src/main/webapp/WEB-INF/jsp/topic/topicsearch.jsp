...
<body>
<form id="dataForm" action="${path}/m/topic/searchList.do" method="post">
<input type="hidden" name="keywords" id="_keywords"/>
</form>
<div class="wrapper">
   <div class="meeting-search">
       <div>
            <input type="text" placeholder="输入关键词" id="keywords" name="search" onkeyup="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')" onpaste="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"  oncontextmenu = "value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"/>
...
$(document).ready(function() {
  ...
  $("#cancel").click(function(){
	  window.location.href = "${path}/m/topic/topicPage.do";  
  });
  $("#search").click(function(){
	  ...
	  var ss = JSON.parse(localStorage.getItem("topickeys"))||[];
      var arr = [];
      arr.push(keywords);
      ...
      localStorage.setItem("topickeys", JSON.stringify(arr));
      doSearch(keywords);
  });
...
function clearHis(){
	 ...
	 localStorage.removeItem("topickeys");
}
