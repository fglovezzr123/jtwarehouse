package com.tojoy.cn.emay;

import java.util.HashMap;
import java.util.Map;

import com.tojoy.cn.emay.eucp.inter.framework.dto.CustomSmsIdAndMobile;
import com.tojoy.cn.emay.eucp.inter.framework.dto.CustomSmsIdAndMobileAndContent;
import com.tojoy.cn.emay.eucp.inter.http.v1.dto.response.BalanceResponse;
import com.tojoy.cn.emay.eucp.inter.http.v1.dto.response.MoResponse;
import com.tojoy.cn.emay.util.AES;
import com.tojoy.cn.emay.util.GZIPUtils;
import com.tojoy.cn.emay.util.http.EmayHttpClient;
import com.tojoy.cn.emay.util.http.EmayHttpResponseBytesPraser;
import com.tojoy.cn.emay.util.http.EmayHttpResultCode;
import com.tojoy.cn.emay.eucp.inter.framework.dto.PersonalityParams;
import com.tojoy.cn.emay.eucp.inter.http.v1.dto.request.BalanceRequest;
import com.tojoy.cn.emay.eucp.inter.http.v1.dto.request.MoRequest;
import com.tojoy.cn.emay.eucp.inter.http.v1.dto.request.ReportRequest;
import com.tojoy.cn.emay.eucp.inter.http.v1.dto.request.SmsBatchOnlyRequest;
import com.tojoy.cn.emay.eucp.inter.http.v1.dto.request.SmsBatchRequest;
import com.tojoy.cn.emay.eucp.inter.http.v1.dto.request.SmsPersonalityAllRequest;
import com.tojoy.cn.emay.eucp.inter.http.v1.dto.request.SmsPersonalityRequest;
import com.tojoy.cn.emay.eucp.inter.http.v1.dto.request.SmsSingleRequest;
import com.tojoy.cn.emay.eucp.inter.http.v1.dto.response.ReportResponse;
import com.tojoy.cn.emay.eucp.inter.http.v1.dto.response.SmsResponse;
import com.tojoy.cn.emay.util.JsonHelper;
import com.tojoy.cn.emay.util.http.EmayHttpRequestBytes;
import com.tojoy.cn.emay.util.http.EmayHttpResponseBytes;
...
public class Example {
	...
	public static void main(String[] args) {
		...
		// 发送单条短信
		setSingleSms(appId,secretKey,host,algorithm,"你好今天天气不错，挺风和日丽的", null, null, "13760262786",isGizp,encode);
		// 发送批次短信[有自定义SMSID]
