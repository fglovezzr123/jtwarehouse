		...
		<div class="I-Pk" style="background: #f2f3f4;width: 100%;">
			<div class="p-content show">
			 ...
			 <input id="isShow" name="isShow" value="2"  type="hidden" />
				<div class="pk-con">
					<p>PK话题：</p>
					<textarea name="topicDesc" id="topicDesc" rows="" cols="" maxlength="100"placeholder="抛出本次PK话题，不超过100汉字" onblur="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')"></textarea>
					<p>红方观点：</p>
					<input type="text" name="redPoint" id="redPoint" value=""maxlength="50"  placeholder="不得超过50汉字" onblur="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" />
					<p>蓝方观点：</p>
					<input type="text" name="bluePoint" id="bluePoint" value="" maxlength="50" placeholder="不得超过50汉字" onblur="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')"/>
					<p>话题阐述：</p>
					<div class="pl">
					<textarea name="topicExplain" id="topicExplain" rows="" cols="" placeholder="请输入您要阐述的内容" onblur="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')"></textarea>
					</div>
				</div>
				<div class="cx">
					<div class="no">
