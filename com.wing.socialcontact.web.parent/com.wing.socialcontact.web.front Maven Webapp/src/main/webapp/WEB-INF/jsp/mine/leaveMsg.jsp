...
<html>
	...
	<body style="background: #f2f3f4;">
		<div class="msg">
			<textarea name="content" id="content" rows="" cols="" placeholder="请输入你要留言的内容" oninput="Check(this)" maxLength=200 onkeyup="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" onpaste="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" oncontextmenu="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" ></textarea>
		...
		function isEmojiCharacter(substring) {  
			...
			function Check(txt)
			{
			    TextCount=$.trim(txt.value).length;  
			    $("#num").text(TextCount);   
			    if(TextCount>=200){
			    	alert("留言内容不能大于200字");
			    	return;
