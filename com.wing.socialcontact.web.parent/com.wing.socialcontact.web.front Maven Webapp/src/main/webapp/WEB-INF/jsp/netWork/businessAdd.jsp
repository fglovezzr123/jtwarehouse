			...
			<div class="p-content show" style="margin-top:0">
			 ...
			 <input id="isShow" name="isShow" value="2"  type="hidden" />
				<div class="hz_content">
					<div class="h-items">
						<p>合作标题:</p>
						<input type="text" name="titles" id="titles" value=""maxlength="50" placeholder="一句话描述你的合作内容，不得超过50个汉字" onblur="value=clearYEmoil(value)" onpaste="value=clearYEmoil(value)" oncontextmenu="value=clearYEmoil(value)" />
					</div>
					<div class="h-lb">
						<span>合作分类：</span>
					...
					<div class="h-items">
						<p>合作诉求:</p>
						<input type="text" name="appealSummary" id="appealSummary"maxlength="50" value=""  placeholder="一句话描述你的诉求内容，不得超过50个汉字" onblur="value=clearYEmoil(value)" onpaste="value=clearYEmoil(value)" oncontextmenu="value=clearYEmoil(value)"/>
					</div>
					<div class="y-items">
						<p>有效期:</p>
						<div class="time">
							<input type="date" name="startTime" id="startTime"  value=""    style="width:140px;" />  
							<span style="line-height:normal">&nbsp;至&nbsp;</span>
							<input type="date" name="endTime"  id="endTime"  value="" style="width:140px;"  />
						</div>
					</div>
					<div class="x-items">
						<p>悬赏金额：</p>
					...
					<div class="hz-con">
						<p>合作说明:</p>
						<textarea name="appealDesc" id="appealDesc" value="" maxlength="500" placeholder="详细描述您的合作需求，可以更快速促成合作，不超过500个汉字"  onblur="value=clearYEmoil(value)" onpaste="value=clearYEmoil(value)" oncontextmenu="value=clearYEmoil(value)"></textarea>
					</div>
				</div>
				<div class="cx">
					<div class="no">
