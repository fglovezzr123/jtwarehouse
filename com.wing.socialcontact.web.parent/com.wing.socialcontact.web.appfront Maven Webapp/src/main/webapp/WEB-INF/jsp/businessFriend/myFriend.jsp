...
<html>
	...
	<body>
		<div class="T-talkAbout" style="background: #f2f3f4;width: 100%; height: 100%;">
			<div class="wrapper" id="wrapper" style="padding-bottom:.6rem">
				...
				<div class="search-box">
		           ...
		           <div class="search-list">
					...
					<div id="letter"></div>
					<div class="sort_box" style="margin-bottom:1rem">
					</div> 
					<div class="initials">
						<ul>
		...
		<script type="text/javascript">
		 ...
		 zdy_ajax({
			...
			success: function(data,res){
				...
				$(".sort_list").on('click',function(){
					if($(this).attr('data_check')==0){
						console.log($(this).find('input').attr('disabled'))
		 ...
		 //点击完成
		 function wanCheng(){
				  $(".sort_list").each(function(k,n){
					 if($(".sort_list").eq(k).attr('data_check')==1){
						var id = $(".sort_list").eq(k).attr('follow_user')
						console.log(id)
						$(".sort_box .sort_list").each(function(k,n){
							 if($(".sort_box .sort_list").eq(k).attr('follow_user')==id){
								 $(".sort_box .sort_list").eq(k).find('input').prop('checked',true)
							}
						})
					 }
				   })  
			     ...
			     if(strId){
			    	 var len = strId.length
			    	    ...
			    	    if(!qid){
			    	    	...
			    	    	if(qidStatus=="qid1"){
			    	    		if($(".sort_list[data_check='1']").length){
