...
public class MyAction extends BaseAction {
	...
	public @ResponseBody Map paycwy(double je, String czType, HttpServletRequest request, HttpServletResponse response)
		...
		paymentRequestBean.setName_goods("钱包充值");
		...
		System.out.println("商品待签名串：" + SignUtil.genSignData(JSON.parseObject(JSON.toJSONString(paymentRequestBean))));
		...
		return super.getSuccessAjaxResult("操作成功", resultMap);
	}
