...
<div style="width: 98%;margin: 0 auto;" >
	<form  action="advertis/update.do"  method="post" id="advertis_form" enctype="multipart/form-data" >
		<table class="table table-bordered">
			...
			<tr>
		  	...
		  	<tr>
		    	...
		    	<td>
		    		<input type="text" name="resolvingpower" id="resolvingpower" class="easyui-validatebox" required="true" maxlength="150" value="${b.resolvingpower }"/>
		    	</td>
		  	</tr>
		  	<tr>
				<th>排序:</th>
