...
<div style="width: 98%;margin: 0 auto;" >
	<form  action="pageConfig/pageQuickEntry/add.do"  method="post" id="pageQuickEntry_form" enctype="multipart/form-data" >
		<table class="table table-bordered">
			<tr>
				<th width="15%">入口名称:</th>
				<td width="80%"><input type="text" name="name" class="easyui-validatebox" required="true" data-options="validType:['length[1,20]']"  maxlength="20" /></td>
			</tr>
			<tr>
				<th>图片:</th>
				<td>
			...
			<tr>
				<th>链接地址:</th>
				<td><input type="text" name="linkUrl" class="easyui-validatebox" required="true" data-options="validType:['length[1,150]']"  maxlength="150" /></td>
			</tr>
			<tr>
				<th>排序:</th>
