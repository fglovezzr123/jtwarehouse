    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="invest-intention">
                   投资额度：
                   <input type="text" name="position" id="position"  onkeyup="clearNoNum(this)"  placeholder="金额（最多为 9999 9999）"/>
                   <strong>RMB(元)</strong>
            </div>
            <div class="invest-intention">
                   联系人：
       <input type="text"  name="username" id="username" onkeyup="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" onpaste="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" oncontextmenu="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" placeholder="请输入联系人姓名" />
            </div>
            <div class="invest-intention"> 联系电话：  <input type="text"  name="phone" id="phone" placeholder="请输入联系电话"/>
            </div>
            ...
            <div class="invest-intention-text">
                   <textarea  name="message"  id="message" onkeyup="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" onpaste="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')" oncontextmenu="value=value.replace(/[^(\`~!#$\^&@%*+\-\(\)=\|\{\}\':;\',\\.\<\>\/?~！#￥……&*（）——{}【】‘；：”“'。，、？\]\[‘'《》·_)|(a-zA-Z0-9\u4E00-\u9FA5)]/g,'')"  placeholder="请简要说明您对推荐项目的情况，不超过200字" ></textarea>
    	...
    	function save(){
    		...
    		zdy_ajax({
				...
				success: function(data1,data){
					if(data.code == 0){
						 alert("投资意向已提交",function(){
							 var last_url="${path}/m/investment/invention/introduce.do";
