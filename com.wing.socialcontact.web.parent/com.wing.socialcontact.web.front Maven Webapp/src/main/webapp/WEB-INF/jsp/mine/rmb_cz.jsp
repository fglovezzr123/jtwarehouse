...
<html lang="en">
	...
	<body style="background: #f2f3f4;">
		...
		<div class="rmbCharge-btm active_A" id="cz_button2">微信充值</div>
		<div class="rmbCharge-btm active_A" id="cz_button1">网银充值</div>
		<div style="display: none">
			<form action="" method="post" id="form" style="margin-top:2.1rem;">
		        <input type="text" name="req_data" id="req_data" value="" style="display:none">
		  	</form>
		</div>
		<script type="text/javascript">
			...
			$(function(){
				...
				//网银支付
				function paywy(je,czType){
					wxflag=false;
					zdy_ajax({
						url :"${path}/m/my/paycwy.do", 
					    type : 'post', 
					    dataType : 'json', 
					    data:{
					    	je:je,
					    ...
					    success : function(data,res){
					    	console.log(res);
	                        if(res.code==0){
	                            var param = res.dataobj;
	                            $("#req_data").val(param.requestParameter);
	                            console.log(param.requestParameter);
	                            $('#form').attr('action',param.server_url);
	                            $('#form').submit();
	                        }else{
