...
<div style="width: 800px;margin: 0 auto;" >
	<form  action="news/addBoss.do"  method="post"   id="news_form" afterCallback="saveCallback" enctype="multipart/form-data">
		 <input id="imagePath" name="imagePath" value=""  type="hidden" />
		  <table class="table table-nobordered " style="margin-top: 25px;">
			  ...
			  <tr>
			    	...
			    	<td>
			     		<input type="text" name="newsTitle" class="easyui-validatebox" required="true"  data-options="validType:['length[1,50]']"   maxlength="50" />
			    	</td>
			  </tr>
			 <tr>
			  ...
			  <tr id="sfjb_tr_1">
			    	...
			    	<td >
			     		<input type="text" name="charge"  id="charge" class="easyui-numberbox"  maxlength="8" min="1" max="99999999" />
			   </td>
			   </tr>
			  <tr>
				 <th></th>
