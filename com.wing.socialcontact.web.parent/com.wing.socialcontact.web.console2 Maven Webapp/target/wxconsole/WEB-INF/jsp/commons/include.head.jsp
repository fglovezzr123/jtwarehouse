...
<% 
	request.getSession().setAttribute("sversion", "0.1111");
%>
...
<script type="text/javascript" src="resource/js/editor/kindeditor.js" charset="utf-8"></script>
<script type="text/javascript" src="resource/js/editor/lang/zh_CN.js" charset="utf-8"></script>
<link rel="stylesheet" type="text/css" href="resource/js/editor/themes/default/default.css" />
...
<script type="text/javascript" src="resource/js/util.js?v=${sversion}"></script>
...
<!-- 文件上传组件 -->
<script src="resource/js/webuploader/webuploader.min.js" type="text/javascript"></script>
<!-- 聚合页配置 -->
<script type="text/javascript" src="resource/js/jhy.js"></script>
