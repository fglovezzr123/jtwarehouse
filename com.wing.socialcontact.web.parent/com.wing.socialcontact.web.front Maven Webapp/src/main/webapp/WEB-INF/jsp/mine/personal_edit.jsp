...
<html lang="en">
	...
	<body style="background: #f2f3f4;">
		...
		$("#personal_info").on("input",function(){
			if($("#personal_info").val().length>200){
				$("#personal_info").val($("#personal_info").val().substr(0,200));
				$("#dyContentLength").html($("#personal_info").val().length+'/200');
			}
		})
