		...
		<div class="">
			<c:choose>
				<c:when test="${empty tjyuser.headPortrait }">
			    	<div id="user-icon"  style="background:url(${path}/resource/img/icons/user-incon.png) no-repeat center;height:1.54rem;width:1.54rem; margin:0 auto; background-size:100%;border-radius:50%;border:0.07rem solid white;margin-top:-0.77rem;"></div>
				</c:when>
				<c:otherwise>
					<c:choose>
...
<%-- 							<div id="user-icon"  style="background:url(${path}${tjyuser.headPortrait}) no-repeat center;height:1.54rem;width:1.54rem; margin:0 auto; background-size:100%;border-radius:50%;border:0.07rem solid white;margin-top:-0.77rem;"></div> --%>
			...
			<div id="focus">
				<div class="names">${tjyuser.nickname}</div>
