...
<html lang="en">
	...
	<body>
		<div class="Z-register-login" style="background: #f2f3f4;width: 100%;padding-bottom:1rem;">
			...
			<div class="Z-item">
				<span>注册资金(万元)</span>
				<input type="text" id="reconCapital" name="reconCapital" class="name" value="${tjyUser.reconCapital}" placeholder="请输入注册资金" maxlength="4" onkeyup="clearNoNum2(this);" onpaste="return false"/>
			</div>
			<div class="Z-item">
				<span>行业</span>
