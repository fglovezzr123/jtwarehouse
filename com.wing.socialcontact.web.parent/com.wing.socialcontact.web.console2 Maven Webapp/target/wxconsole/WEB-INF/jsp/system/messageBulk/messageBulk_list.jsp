		...
		<div id="${param.rel}_toolbar" class="search-div">
			<form onsubmit="return datagridSearch(this,'${param.rel }_datagrid');" >
			    <div class="search-content">
					<span>
						<label style="width: 100px;">信息类型：</label>
						<select name="msgType"  style="width: 120px;">
					...
					<span>
						<label style="width: 100px;">信息内容：</label>
				...
				<div class="search-toolbar">
					...
					<%-- 	<shiro:hasPermission name="messageBulk:add"> --%>	
						...
						href="messagebulk/del.do" target="selectedTodo"  title="确定要删除吗?" warn="至少勾选一条记录">批量删除</a>
