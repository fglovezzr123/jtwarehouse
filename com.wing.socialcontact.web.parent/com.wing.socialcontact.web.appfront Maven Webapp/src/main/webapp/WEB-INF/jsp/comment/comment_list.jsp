		...
		<div class="Z-register-login" style="background: #f2f3f4;width: 100%;height: 100%;">
			...
			<div style="padding-bottom:1rem">
			  ...
			  <div class="msgBox1 ">
				...
				<div class="shuru">
					<input type="text" name="huihu" id="huihu" value="" maxLength=200 placeholder="请回复"  onkeyup="value=clearYEmoil(value)" onpaste="value=clearYEmoil(value)" oncontextmenu="value=clearYEmoil(value)" />
