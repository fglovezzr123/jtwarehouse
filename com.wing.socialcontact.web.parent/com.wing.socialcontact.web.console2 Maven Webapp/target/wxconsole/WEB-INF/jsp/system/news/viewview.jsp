	...
	<form  action="news/updateview.do"   method="post"   id="news_form" afterCallback="saveCallback" enctype="multipart/form-data" enctype="multipart/form-data">
		 ...
		 <table class="table table-nobordered " style="margin-top: 25px;">
			   <tr>
			    	...
			    	<td >
			     		<input type="text" name="viewUser"  readonly="readonly" value="${n.viewUser}" class="easyui-validatebox" required="true"  data-options="validType:['length[1,10]']"   maxlength="10" />
			    	</td>
			  </tr>
			  <tr>
			    	<th style="width: 80px">专访标题：</th>
			    	<td>
			     		<input type="text" name="newsTitle" readonly="readonly" value="${n.newsTitle}" class="easyui-validatebox" data-options="required:true" style="width:480px;" data-options="validType:['length[1,50]']" maxlength="50" />
			    	</td>
			  </tr>
			   <tr>
			  ...
			  <tr>
				...
				<td>
					<input type="text" name="sort"  onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" readonly="readonly" value="${n.sort}"  class="easyui-numberbox" required="true"    maxlength="3" />
				</td>
			  </tr>
			    <tr>
			    	<th style="width: 80px">来源：</th>
			    	<td>
			     		<input type="text" readonly="readonly" name="source" value="${n.source}" class="easyui-validatebox" required="true"  data-options="validType:['length[1,20]']" maxlength="20" />
			    	</td>
			    	<td>&nbsp;</td>
			  </tr>
			   <tr>
			    	...
			    	<td>
			    	<input type="text" readonly="readonly" name="summary" id="summary" value="${n.summary}" class="easyui-validatebox" style="width:480px;"  required="true" data-options="validType:['length[1,50]']"   maxlength="50" />
			    	</td>
			    	<td>&nbsp;</td>
			  </tr>
			   <tr>
			  ...
			  <tr>
			    	...
			    	<td>
			    	<textarea readonly="readonly" name="content" style="width:320px;height:600px;" id="content">${n.content}</textarea>
			    	</td>
			  </tr>
		</table>	 
