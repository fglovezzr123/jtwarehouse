	...
	<body style="background: #f2f3f4;">
		<div class="I-Pk" style="background: #f2f3f4;width: 100%;">
			<div class="p-content show" style="margin-top:0">
				<div class="pl">
					<textarea name="content" id="content" rows="" cols="" placeholder="请输入您要商洽的内容" onkeyup="value=clearYEmoil(value)" onpaste="value=clearYEmoil(value)" oncontextmenu="value=clearYEmoil(value)"></textarea>
