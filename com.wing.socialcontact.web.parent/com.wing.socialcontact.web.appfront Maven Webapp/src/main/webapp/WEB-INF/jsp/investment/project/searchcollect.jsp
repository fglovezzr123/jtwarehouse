...
<body>
<form id="dataForm" action="${path}/m/project/collect/searchlist.do" method="post">
<input type="hidden" name="keywords" id="_keywords"/>
</form>
<div class="wrapper">
   <div class="meeting-search">
       <div>
            <input type="text" placeholder="输入项目关键词" id="keywords" onkeyup="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')" onpaste="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"  oncontextmenu = "value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"/>
...
$(document).ready(function() {
  ...
  $("#cancel").click(function(){
	  window.location.href = "${path}/m/project/collect/index.do";  
  });
